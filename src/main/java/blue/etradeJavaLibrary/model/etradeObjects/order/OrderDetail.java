...
public class OrderDetail extends EtradeObject<OrderDetail>
    ...
    public XMLDataFields getDataFields() {
        return new XMLDataFields()
                .addStringField("accountId", accountId)
                .addStringField("orderType", orderType)
                .addStringField("orderTerm", orderTerm)
                .addStringField("priceType", priceType)
                .addStringField("priceValue", priceValue)
                .addStringField("limitPrice", limitPrice)
                .addStringField("stopPrice", stopPrice)
                .addStringField("stopLimitPrice", stopLimitPrice)
                .addStringField("offsetType", offsetType)
                .addStringField("offsetValue", offsetValue)
                .addStringField("marketSession", marketSession)
                .addStringField("routingDestination", routingDestination)
                .addStringField("initialStopPrice", initialStopPrice)
                .addStringField("allOrNone", allOrNone)
                .addStringField("previewId", previewId)
                .addArrayListField("instrument", instrument);
    }
